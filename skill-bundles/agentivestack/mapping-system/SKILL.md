...
- `/domain-modelling` — stress-test a plan against the domain model (deeper, interactive)
- `/architecting` — surface friction and design better interfaces (prescriptive)
- `/writing-specs` — after understanding the picture, formalize a plan
