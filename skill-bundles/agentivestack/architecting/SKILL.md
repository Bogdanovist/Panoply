...
- `/domain-modelling` — stress-test the chosen design against the domain model
- `/writing-specs` — formalize the improvement into a spec
- `/slicing-features` — break the refactor into vertical slices
- `/mapping-system` — understand the broader system before refactoring
