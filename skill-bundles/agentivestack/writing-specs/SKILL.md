...
- `/domain-modelling` — stress-test the spec against the domain model before implementation
- `/slicing-features` — break the spec into vertical slices for implementation
